...
//        };
    ...
    public void predicateIsOdd() {
        ...
        // TODO - Convert the anonymous inner class to a lambda
        Predicate<Integer> oddPredicate = (Integer integer) -> integer % 2 == 1;
...
//        Function<String, String> toUppercase = (String string) -> string.toUpperCase();
...
//        Function0<List<String>> supplier = () -> FastList.newList();
        Function0<List<String>> supplier = FastList::new;
...
//        };
    ...
    public void procedure2() {
        ...
        // TODO - Convert the anonymous inner class to a lambda
        Procedure2<String, String> procedure2 = (String key, String value) -> result.put(key.toUpperCase(), value.toUpperCase());
